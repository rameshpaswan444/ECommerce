        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:mx-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p className="opacity-50 text-sm">5676 Ratings</p>
              <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3564 Reviews</p>
              </div>
        ...
        <Grid container spacing={7}>
            ...
            <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <p className="opacity-60">5456 Ratings</p>
                </div>
                ...
                <Grid container  alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4, height:7}} variant="determinate" value={35} color="success"/>
                    </Grid>
                ...
                <Grid container  alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4, height:7,color:"yellow"}} variant="determinate" value={30} />
                    </Grid>
